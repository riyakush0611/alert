...
//		Log.d(TAG, "shouldOverrideUrl: " + url);
    ...
    public void onPageStarted(String url) {
        ...
        if (this.mainActivity.getUrlLoader() != null) this.mainActivity.getUrlLoader().onPageStarted();
    ...
    public void onPageFinished(GoNativeWebviewInterface view, String url) {
        ...
        // notify UrlLoader, for single-page apps
        if (this.mainActivity.getUrlLoader() != null) this.mainActivity.getUrlLoader().onPageFinished();
